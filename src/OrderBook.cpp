 ...
 * mean price of all the orders. If the vector is empty, the function returns 0.0.
 * 
 * @param orders A vector of OrderBookEntry objects representing the orders.
 * @return double The mean price of the orders. Returns 0.0 if the vector is empty.
 */
